...
const ToggleAccordion = ({ number, title, content }) => {
  ...
  return (
    <div
      className={`rounded-4xl border-1 border-black dark:border-black p-4 md:p-8 cursor-pointer transition-colors duration-300 shadow-box dark:shadow-boxWhite ${
    ...
    >
      <summary className="flex justify-between items-center">
        ...
        <span
          className={`flex items-center bg-gray-100 justify-center md:w-11 max-w-[2.1rem] md:max-w-[2.6rem] text-2xl md:text-4xl font-bold text-black w-full rounded-full border-1 border-black transition-transform duration-500 ${
